...
--
-- Host: 127.0.0.1
-- Generation Time: 24-Maio-2019 às 20:48
...
INSERT INTO `habitos_has_especializacao` (`idHabitos`, `idEspecializacao`, `quantidade`) VALUES
(1, 1, 696);
...
--
ALTER TABLE `especializacao`
  MODIFY `idEspecializacao` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `habitos`
  MODIFY `idHabitos` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `raca`
  MODIFY `idRaca` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
