...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Jun-2019 às 09:19
...
CREATE TABLE `caminho_has_habitos` (
  ...
  `qtd_cam_hab` int(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `caminho_has_habitos` (`idCaminho`, `idHabitos`, `qtd_cam_hab`) VALUES
(1, 1, 69);

-- --------------------------------------------------------

--
-- Estrutura da tabela `caminho_has_patrono`
--

CREATE TABLE `caminho_has_patrono` (
  `idCaminho` int(2) NOT NULL,
  `idPatrono` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `caminho_has_patrono`
--

INSERT INTO `caminho_has_patrono` (`idCaminho`, `idPatrono`) VALUES
(1, 1);
...
CREATE TABLE `descendencia_has_habitos` (
  `idDescendencia` int(4) NOT NULL,
  `idHabitos` int(4) NOT NULL,
  `qtd_desc_hab` int(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `descendencia_has_habitos` (`idDescendencia`, `idHabitos`, `qtd_desc_hab`) VALUES
(1, 1, 5);
...
INSERT INTO `especializacao` (`idEspecializacao`, `idHabitos`, `nome`, `desc_esp`) VALUES
(1, 1, 'Trap', 'Cavalo de Troia'),
(2, 2, 'Disseminar o Caos', 'Dissemina tudo');
...
CREATE TABLE `ficha` (
  ...
  `idReputacao` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `ficha` (`idFicha`, `idRaca`, `idCidade`, `idJogador`, `nome_pers`, `img`, `idade`, `afiliacao`, `cla`, `sorte_dia`, `dist_for`, `dist_con`, `dist_agi`, `dist_des`, `dist_int`, `dist_sab`, `dist_car`, `nivel_pers`, `exp_pers`, `pers_desc`, `pers_hist`, `nota`, `idSanidade`, `idReputacao`) VALUES
(1, 1, 1, 1, 'Personagem Hipotetico 1', 'https://pbs.twimg.com/profile_images/1068864058768658433/2yYNwEgb_400x400.jpg', '123', 'Nao tem', 'Nao tem2', '4', '1', '2', '3', '4', '5', '6', '7', 0, 0, 'Grandes olhos pequenos', 'Nasceu um dia', '100', 1, 1),
(2, 2, 1, 1, 'Personagem Hipotetico 2', 'https://pbs.twimg.com/media/DrxYNoxX0AMETWp.jpg:large', '321', 'Nao ', 'Nao 2', '1', '4', '6', '7', '9', '0', '1', '8', 0, 0, 'Grandes olhos pequenos', 'Nasceu um dia', '100', NULL, NULL),
(3, 1, 1, 1, 'Personagem Hipotetico 3 de nome grande pracarai', 'https://pbs.twimg.com/media/Ds4QeCtWoAEMNah.jpg:large', '321', 'Nao ', 'Nao 2', '1', '4', '6', '7', '9', '0', '1', '8', 0, 0, 'Grandes olhos pequenos', 'Nasceu um dia', '100', NULL, NULL);
...
--
-- Estrutura da tabela `ficha_has_especializacao`
--

CREATE TABLE `ficha_has_especializacao` (
  `idFicha` int(10) NOT NULL,
  `idEspecializacao` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `ficha_has_especializacao`
--

INSERT INTO `ficha_has_especializacao` (`idFicha`, `idEspecializacao`) VALUES
(2, 1);
...
INSERT INTO `ficha_has_habitos` (`idFicha`, `idHabitos`, `qtd_fic_hab`) VALUES
(1, 1, 50),
(2, 2, 5);
...
--
-- Extraindo dados da tabela `ficha_has_patrono`
--

INSERT INTO `ficha_has_patrono` (`idFicha`, `idPatrono`) VALUES
(3, 1);
...
INSERT INTO `item` (`idItem`, `nome`, `desc_item`, `peso`, `valor_magico`, `valor`, `moeda`) VALUES
(1, 'Pedra', 'PEsada pra caralho', '999.99', '0', '12', 0);
...
--
-- Extraindo dados da tabela `raca_has_habilidades`
--

INSERT INTO `raca_has_habilidades` (`idRaca`, `idHabilidades`) VALUES
(1, 1);
...
CREATE TABLE `raca_has_habitos` (
  `idRaca` int(4) NOT NULL,
  `idHabitos` int(4) NOT NULL,
  `qtd_rac_hab` int(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `raca_has_habitos` (`idRaca`, `idHabitos`, `qtd_rac_hab`) VALUES
(1, 1, 20),
(1, 2, 2);
...
--
-- Indexes for table `caminho_has_patrono`
--
ALTER TABLE `caminho_has_patrono`
  ADD PRIMARY KEY (`idCaminho`,`idPatrono`),
...
ALTER TABLE `ficha`
  ...
  ADD KEY `idReputacao` (`idReputacao`);
...
--
-- Indexes for table `ficha_has_especializacao`
--
ALTER TABLE `ficha_has_especializacao`
  ADD KEY `idFicha` (`idFicha`),
  ADD KEY `idEspecializacao` (`idEspecializacao`);
...
--
ALTER TABLE `descendencia`
  MODIFY `idDescendencia` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `especializacao`
--
ALTER TABLE `especializacao`
  MODIFY `idEspecializacao` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `habitos`
  MODIFY `idHabitos` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `idiomas`
--
ALTER TABLE `idiomas`
  MODIFY `idIdiomas` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `jogador`
  MODIFY `idJogador` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `patrono`
--
ALTER TABLE `patrono`
  MODIFY `idPatrono` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `raca`
--
ALTER TABLE `raca`
  MODIFY `idRaca` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tracos_raciais`
  MODIFY `idTracos_Raciais` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Limitadores para a tabela `caminho_has_patrono`
--
ALTER TABLE `caminho_has_patrono`
  ADD CONSTRAINT `caminho_has_patrono_ibfk_1` FOREIGN KEY (`idCaminho`) REFERENCES `caminho` (`idCaminho`),
  ADD CONSTRAINT `caminho_has_patrono_ibfk_2` FOREIGN KEY (`idPatrono`) REFERENCES `patrono` (`idPatrono`);
...
--
ALTER TABLE `especializacao`
  ADD CONSTRAINT `especializacao_ibfk_1` FOREIGN KEY (`idHabitos`) REFERENCES `habitos` (`idHabitos`);
...
ALTER TABLE `ficha`
  ...
  ADD CONSTRAINT `ficha_ibfk_2` FOREIGN KEY (`idReputacao`) REFERENCES `reputacao` (`idReputacao`),
...
--
-- Limitadores para a tabela `ficha_has_especializacao`
--
ALTER TABLE `ficha_has_especializacao`
  ADD CONSTRAINT `ficha_has_especializacao_ibfk_1` FOREIGN KEY (`idFicha`) REFERENCES `ficha` (`idFicha`),
  ADD CONSTRAINT `ficha_has_especializacao_ibfk_2` FOREIGN KEY (`idEspecializacao`) REFERENCES `especializacao` (`idEspecializacao`);
