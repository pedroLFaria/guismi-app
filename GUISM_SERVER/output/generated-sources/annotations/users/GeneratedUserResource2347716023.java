...
final public class GeneratedUserResource2347716023 implements HttpHandler {
	...
	private void runMethod( final HttpServerExchange exchange, final byte[] bodyData ){
		if ( exchange.isInIoThread() )
			exchange.dispatch( ()-> this.runMethod( exchange, bodyData ) );
				...
				instance.persistUser( 
			methodDataProvider.getBody( exchange, users.User.class, bodyData ) );
    ...
    public String toString(){
        return "users.UserResource.persistUser";
    }
}