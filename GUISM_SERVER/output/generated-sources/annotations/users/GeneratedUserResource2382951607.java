...
@WebResource( path="/users/{id}/", method="GET" )
final public class GeneratedUserResource2382951607 implements HttpHandler {
	...
	private void runMethod( final HttpServerExchange exchange, final byte[] bodyData ){
		if ( exchange.isInIoThread() )
			exchange.dispatch( ()-> this.runMethod( exchange, bodyData ) );
				...
				final users.User response = instance.retrieveUserById( 
    ...
    public String toString(){
        return "users.UserResource.retrieveUserById";
    }
}