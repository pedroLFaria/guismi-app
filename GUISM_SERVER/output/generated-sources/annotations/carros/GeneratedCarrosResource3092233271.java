...
@WebResource( path="/api/carros/", method="POST" )
final public class GeneratedCarrosResource3092233271 implements HttpHandler {
	...
	private void runMethod( final HttpServerExchange exchange, final byte[] bodyData ){
		if ( exchange.isInIoThread() )
			exchange.dispatch( ()-> this.runMethod( exchange, bodyData ) );
				...
				final kikaha.urouting.api.Response response = instance.insertNewCar( 
			methodDataProvider.getBody( exchange, carros.Carro.class, bodyData, "application/json" ) );
    ...
    public String toString(){
        return "carros.CarrosResource.insertNewCar";
    }
}