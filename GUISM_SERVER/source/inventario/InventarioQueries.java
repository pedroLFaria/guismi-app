...
public interface InventarioQueries {
    ...
    @SqlQuery("SELECT INVENTARIO.* FROM FICHA LEFT JOIN FICHA_HAS_INVENTARIO ON FICHA.IDFICHA = FICHA_HAS_INVENTARIO.IDFICHA " +
            "LEFT JOIN INVENTARIO ON FICHA_HAS_INVENTARIO.IDINVENTARIO = INVENTARIO.IDINVENTARIO WHERE FICHA.IDFICHA = :idFicha")
