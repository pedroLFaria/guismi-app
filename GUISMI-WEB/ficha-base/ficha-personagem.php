            ...
            <main class="col offset-2 h-100">
                <div class="row bg-light">
                    <div class="col-12 py-4">
                        Site De arrombado Que não tem um meme decente
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="row col-md-12">
                            ...
                            <div class="col-md-2 inline">
                                ...
                                <input type="text" class="c form-control " placeholder="EX: Bucetalli"  id="nome_pers_input" />
                            </div>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <ul style="list-style:none; column-count:2" >
                                                <li>Sanidade * 0 * : Normal</li>
                                                <li>Sanidade "-1" : Broly</li>
                                                <li>Sanidade "-2" : Fabio Assunção</li>
                                                <li>Sanidade "-3" : Diavolo</li>
                                                <li>Sanidade "-4" : Adlet vs hans(No Templo)</li>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <p style="text-align: center;"> Você esta a tantos niveis de se tornar menos inutil</p>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <span id='exp_pers_nivel'> Imagine uma função que volta quanto exp tu tem que ter nesse nivel</span>
